...
<!-- <img class="slide-image" showInPresentation="true" src="\imgs\pic01.png" style="top:4.52%; left:29.94%; width:47.60%; z-index:-1" /> -->
<div class="signature">
...
<!-- <img class="slide-image" showInPresentation="true" src="\imgs\pic03.png" style="top:37.91%; left:32.44%; width:44.66%; z-index:-1" /> -->
...
<!-- <img class="slide-image" showInPresentation="true" src="\imgs\pic04.png" style="top:38.79%; left:76.72%; width:27.33%; z-index:-1" /> -->
...
<!-- <img class="slide-image" showInPresentation="true" src="\imgs\pic05.png" style="top:33.26%; left:33.68%; width:42.31%; z-index:-1" /> -->
...
- Classical OOP and inheritance in JavaScript
  ...
  - The prototype chain
<!-- <img class="slide-image" showInPresentation="true" src="\imgs\pic06.png" style="top:37.24%; left:91.77%; width:13.05%; z-index:-1" /> -->
<!-- <img class="slide-image" showInPresentation="true" src="\imgs\pic07.png" style="top:61.27%; left:84.47%; width:18.56%; z-index:-1" /> -->
...
<!-- attr: { id:'', class:'slide-section', showInPresentation:true, hasScriptWrapper:true, style:'' } -->
# Trainers Team
<!-- <img class="slide-image" showInPresentation="true" src="\imgs\pic08.png" style="top:30.98%; left:75.20%; width:27.64%; z-index:-1" /> -->
<!-- <img class="slide-image" showInPresentation="true" src="\imgs\pic09.png" style="top:8.57%; left:75.20%; width:27.64%; z-index:-1" /> -->
<!-- <img class="slide-image" showInPresentation="true" src="\imgs\pic10.png" style="top:52.01%; left:75.20%; width:27.64%; z-index:-1" /> -->
<!-- <img class="slide-image" showInPresentation="true" src="\imgs\pic11.png" style="top:21.15%; left:4.68%; width:64.77%; z-index:-1" /> -->
...
<!-- <img class="slide-image" showInPresentation="true" src="\imgs\pic12.png" style="top:11.46%; left:83.27%; width:21.16%; z-index:-1" /> -->
...
<!-- <img class="slide-image" showInPresentation="true" src="\imgs\pic13.png" style="top:22.04%; left:78.59%; width:30.86%; z-index:-1" /> -->
...
<!-- <img class="slide-image" showInPresentation="true" src="\imgs\pic14.png" style="top:13.22%; left:84.21%; width:19.39%; z-index:-1" /> -->
...
<!-- <img class="slide-image" showInPresentation="true" src="\imgs\pic15.png" style="top:12.34%; left:87.02%; width:18.68%; z-index:-1" /> -->
...
<!-- <img class="slide-image" showInPresentation="true" src="\imgs\pic16.png" style="top:11.81%; left:84.15%; width:12.23%; z-index:-1" /> -->
<!-- <img class="slide-image" showInPresentation="true" src="\imgs\pic17.png" style="top:56.42%; left:84.15%; width:12.23%; z-index:-1" /> -->
<!-- <img class="slide-image" showInPresentation="true" src="\imgs\pic18.png" style="top:35.48%; left:84.30%; width:12.63%; z-index:-1" /> -->
...
<!-- <img class="slide-image" showInPresentation="true" src="\imgs\pic19.png" style="top:45.84%; left:14.97%; width:21.32%; z-index:-1" /> -->
<!-- <img class="slide-image" showInPresentation="true" src="\imgs\pic20.png" style="top:8.82%; left:70.44%; width:30.48%; z-index:-1" /> -->
<!-- <img class="slide-image" showInPresentation="true" src="\imgs\pic21.png" style="top:46.21%; left:56.14%; width:43.95%; z-index:-1" /> -->
<!-- <img class="slide-image" showInPresentation="true" src="\imgs\pic22.png" style="top:46.88%; left:57.21%; width:12.22%; z-index:-1" /> -->
<!-- <img class="slide-image" showInPresentation="true" src="\imgs\pic23.png" style="top:33.12%; left:71.24%; width:10.71%; z-index:-1" /> -->
...
<!-- <img class="slide-image" showInPresentation="true" src="\imgs\pic26.png" style="top:43.09%; left:7.49%; width:45.33%; z-index:-1" /> -->
<!-- <img class="slide-image" showInPresentation="true" src="\imgs\pic27.png" style="top:43.14%; left:83.62%; width:19.94%; z-index:-1" /> -->
<!-- <img class="slide-image" showInPresentation="true" src="\imgs\pic28.png" style="top:7.42%; left:33.06%; width:19.61%; z-index:-1" /> -->
<!-- <img class="slide-image" showInPresentation="true" src="\imgs\pic29.png" style="top:4.19%; left:58.09%; width:16.09%; z-index:-1" /> -->
<!-- <img class="slide-image" showInPresentation="true" src="\imgs\pic30.png" style="top:3.53%; left:75.48%; width:14.10%; z-index:-1" /> -->
<!-- <img class="slide-image" showInPresentation="true" src="\imgs\pic31.png" style="top:5.73%; left:94.27%; width:12.78%; z-index:-1" /> -->
<!-- <img class="slide-image" showInPresentation="true" src="\imgs\pic32.png" style="top:45.84%; left:58.90%; width:20.06%; z-index:-1" /> -->
<!-- <img class="slide-image" showInPresentation="true" src="\imgs\pic33.png" style="top:11.92%; left:9.79%; width:19.86%; z-index:-1" /> -->
